  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <div className="border-t pt-8 text-center text-sm text-slate-600">
        ...
        <p className="mt-2">Last Security Audit: November 2025 | Next Scheduled Audit: February 2026</p>
        <p className="mt-4 text-xs">This page is updated regularly. Last update: November 2025</p>
      </div>
    </div>
  )
}
